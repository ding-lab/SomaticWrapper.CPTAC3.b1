...
* `/import`: Where input from BamMap resides.  Because the data may live on different drives for different samples even in same
...
Defined by `IMAGED_H` in `sw.config.sh`
